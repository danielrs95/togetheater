...
export default function Trending () {
	...
	useEffect(()=>{
		const fetchData = async() => {
			const result = await axios(`https://api.themoviedb.org/3/movie/upcoming?api_key=${process.env.REACT_APP_API_KEY}`)
	...
	return(
		<div className='container-fluid mt-5 pt-1'>
			<div>
				<h1 className='componentTitle'>Upcoming movies</h1>
			</div>
